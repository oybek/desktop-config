...
-- MEM
function mb2gb(m)
	return math.floor(m / 1024 * 100 + 0.5) / 100
end

local memicon = wibox.widget.imagebox(theme.widget_mem)
local mem = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.font(theme.font, " " .. mb2gb(mem_now.used)  .. "/" .. mb2gb(mem_now.total) .. " GB "))
    end
})
...
--[[
local tempwidget = awful.widget.watch({awful.util.shell, '-c', 'sensors | grep temp'}, 30,
